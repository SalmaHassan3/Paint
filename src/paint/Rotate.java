...
public class Rotate extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter the angle in degrees:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        paintJFrame.selectedPolygon.setAngle( paintJFrame.selectedPolygon.getAngle()+Float.parseFloat(jTextField1.getText()));
     ...
     else if(paintJFrame.flag==2)
     {
        
        paintJFrame.selectedEllipticalShape.setAngle( paintJFrame.selectedEllipticalShape.getAngle()+Float.parseFloat(jTextField1.getText()));
        paintJFrame.jPanel1.update( paintJFrame.g2);
